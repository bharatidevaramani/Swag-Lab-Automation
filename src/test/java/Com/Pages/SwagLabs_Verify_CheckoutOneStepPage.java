...
public class SwagLabs_Verify_CheckoutOneStepPage {
    ...
    private static final By VerifyCheckoutInfo = By.cssSelector("div[class='summary_info'] div:nth-child(4)");
    ...
    public static void assertOrderSuccessful() {
        Util.assertWebElementContains(VerifyCheckoutInfo, "FREE PONY EXPRESS DELIVERY!");
    }
